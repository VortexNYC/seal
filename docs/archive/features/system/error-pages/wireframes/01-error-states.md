# System Error Pages Wireframes - All States
...
│                                                                             │
│                                                                             │
│    This feature requires workspace owner or admin permissions              │
│                                                                             │
│                                                                             │
│    ┌─────────────────────────────────────────────────────────────────────┐  │
│    │                         ← Go Back                                   │  │
...
│                                                                             │
│                                                                             │
│    Our team has been notified and is working to fix this problem           │
│                                                                             │
│                                                                             │
│    Error ID: ERR-2024-0215-1234567                                        │
│                                                                             │
│                                                                             │
│    ┌─────────────────────────────────────────────────────────────────────┐  │
│    │                         🔄 Try Again                                │  │
...
│    └─────────────────────────────────────────────────────────────────────┘  │
│                                                                             │
│                        [📊 Check Status Page] [📧 Report Issue]            │
│                                                                             │
...
│                                                                             │
│                                                                             │
│    You were signed out after being inactive for too long                   │
│                                                                             │
...
### 🚀 Pro Feature Required (403 Variant)
...
│                                                                             │
│                                                                             │
│    Upgrade to Pro for unlimited documents, team members, and API access    │
│                                                                             │
│                                                                             │
│    ┌─────────────────────────────────────────────────────────────────────┐  │
│    │                       🚀 Upgrade to Pro                             │  │
...
### 📄 Document Not Found (404 Variant)
...
│                                                                             │
│                        Need access? [Contact Document Owner]               │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
- **Workspace Context**: Maintain workspace context in errors
...
- **Status Updates**: Keep users informed of system status

---

## Accessibility Features

- **Focus Management**: Proper focus handling on error pages
- **Screen Readers**: Error messages properly announced
- **High Contrast**: Clear visual hierarchy for error states
- **Keyboard Navigation**: Full keyboard accessibility
- **Error Announcements**: Live regions for dynamic updates
...
│ │                           📄 ❌                                         │ │
│ │                                                                         │ │
│ │         We couldn't process "quarterly-report.xlsx"                    │ │
│ │                                                                         │ │
│ │ **What happened:**                                                      │ │
│ │ The document couldn't be converted to PDF due to formatting issues.    │ │
│ │                                                                         │ │
│ │ **Try these solutions:**                                                │ │
│ │ • Save the file as PDF from the original application                   │ │
│ │ • Remove complex formatting or embedded objects                        │ │
│ │ • Upload a simplified version of the document                          │ │
│ │                                                                         │ │
...
│ │                         📊 ➡️ 📄 ❌                                      │ │
│ │                                                                         │ │
│ │           PDF conversion failed for "contract-template.docx"            │ │
│ │                                                                         │ │
│ │ **Common causes:**                                                      │ │
│ │ • File is password protected or encrypted                              │ │
│ │ • Document contains unsupported fonts or elements                      │ │
│ │ • File is corrupted or in an older format                              │ │
│ │                                                                         │ │
│ │ **Next steps:**                                                         │ │
│ │ 1. Open the file in its original application                           │ │
│ │ 2. Remove any password protection                                       │ │
│ │ 3. Save as a newer format or directly as PDF                           │ │
│ │ 4. Try uploading again                                                  │ │
│ │                                                                         │ │
│ │ [🔄 Retry Conversion]  [📤 Upload New File]  [💬 Get Help]             │ │
│ │                                                                         │ │
│ └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
...
│ │                                                                         │ │
│ │ [🔄 Try Again]  [💳 Update Payment Method]  [📞 Contact Bank]          │ │
│ │                                                                         │ │
│ │ Your account remains on Free plan until payment succeeds               │ │
│ │                                                                         │ │
│ └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
...
│ │                                                                         │ │
│ │ **Status:** Payment retry in progress                                  │ │
│ │ **Next attempt:** Tomorrow at 3:00 PM                                  │ │
...
│ │                                                                         │ │
│ │ Fix payment within 7 days to restore full access                       │ │
│ │                                                                         │ │
│ └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
...
│ │ • Resets on February 15th                                              │ │
│ │                                                                         │ │
│ │ **Your options:**                                                       │ │
│ │ 1. Wait until next month (9 days)                                      │ │
│ │ 2. Delete old documents to free up space                               │ │
│ │ 3. Upgrade to Pro for unlimited documents                              │ │
│ │                                                                         │ │
│ │ [🗑️ Manage Documents]  [🚀 Upgrade to Pro]  [📅 Remind Me Later]      │ │
│ │                                                                         │ │
│ │ Pro plan: Unlimited documents, team members, and API access            │ │
│ │                                                                         │ │
│ └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│                      ⚠️ Some Files Couldn't Upload                        │
│                                                                             │
│ ┌─────────────────────────────────────────────────────────────────────────┐ │
│ │                                                                         │ │
│ │                       📄 ✅ 📄 ✅ 📄 ❌                                 │ │
│ │                                                                         │ │
│ │             Uploaded 2 of 5 files before hitting limit                 │ │
│ │                                                                         │ │
│ │ **Successfully uploaded:**                                              │ │
│ │ ✅ contract.pdf                                                         │ │
│ │ ✅ agreement.docx                                                       │ │
│ │                                                                         │ │
│ │ **Couldn't upload (quota reached):**                                   │ │
│ │ ❌ proposal.pdf                                                         │ │
│ │ ❌ terms.docx                                                           │ │
│ │ ❌ invoice.xlsx                                                         │ │
│ │                                                                         │ │
│ │ **You have:** 10/10 documents used this month                          │ │
│ │                                                                         │ │
│ │ [🗑️ Delete Old Files]  [🚀 Upgrade to Pro]  [💾 Save Remaining]      │ │
│ │                                                                         │ │
│ └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
