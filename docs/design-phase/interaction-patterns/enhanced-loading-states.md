  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card className="bg-white border-neutral-200">
        ...
        <CardContent>
          <div className="aspect-[8.5/11] bg-neutral-100 rounded-lg flex items-center justify-center">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <Card key={i} className="bg-white border-neutral-200">
            ...
            <CardContent>
              <Skeleton className="h-8 w-16 bg-neutral-200 mb-2" />
              <Skeleton className="h-3 w-24 bg-neutral-200" />
            </CardContent>
          </Card>
        ))}
      ...
      <Card className="bg-white border-neutral-200">
        ...
        <CardContent>
          <Skeleton className="h-64 w-full bg-neutral-200 rounded" />
        </CardContent>
      </Card>
    </div>
  )
        ...
        <div className="flex items-center space-x-3 mb-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-neutral-500">
              {progress}% • 2.3 MB of 5.1 MB • 5 sec left
            </p>
          </div>
        </div>
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          <Card key={i} className="bg-white border-neutral-200">
            <CardContent className="p-6">
              <Skeleton className="h-4 w-20 bg-neutral-200 mb-2" />
              <Skeleton className="h-8 w-12 bg-neutral-200 mb-1" />
              <Skeleton className="h-3 w-16 bg-neutral-200" />
            </CardContent>
          </Card>
        ))}
