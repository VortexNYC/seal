...
**Record the stripeCustomerId**: **\*\*\*\***\_\_\_**\*\*\*\***
...
- External Price ID: **\*\*\*\***\_\_\_**\*\*\*\***
- Credits Included: **\*\*\*\***\_\_\_**\*\*\*\***
- Status: **\*\*\*\***\_\_\_**\*\*\*\***
...
**Record the Stripe customer ID**: **\*\*\*\***\_\_\_**\*\*\*\***
...
| ----------------------------- | ------------------------ | ---------- | ------ |
| User has stripeCustomerId     | cus_xxx                  | **\_\_\_** | [ ]    |
| Subscription exists in Convex | Yes                      | **\_\_\_** | [ ]    |
| Subscription status           | active                   | **\_\_\_** | [ ]    |
| Subscription externalPriceId  | price_xxx                | **\_\_\_** | [ ]    |
| Stripe customer exists        | Yes                      | **\_\_\_** | [ ]    |
| Stripe subscription active    | Yes                      | **\_\_\_** | [ ]    |
| Lookup key matches            | free:personal:monthly:v1 | **\_\_\_** | [ ]    |
