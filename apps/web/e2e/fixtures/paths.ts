...
export const workspaceSlugPath = path.resolve(playwrightStateDir, "workspace-slug.txt");
export const sampleDocumentPath = path.resolve(__dirname, "sample-document.pdf");
