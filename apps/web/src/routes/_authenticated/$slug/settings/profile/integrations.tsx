  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Third-party applications connected to your account</CardDescription>
      </CardHeader>
      <CardContent>
        {apps.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-8 text-center">
            <Unplug className="text-muted-foreground/50 h-12 w-12" />
            <p className="text-muted-foreground mt-4 text-sm">No connected apps</p>
            <p className="text-muted-foreground text-xs">Apps you authorize will appear here</p>
          </div>
        ) : (
                  ...
                  <div className="text-muted-foreground flex flex-col gap-1 text-sm sm:flex-row sm:items-center">
                    ...
                    {app.lastActivityAt && (
                      <>
                        ...
                        <span>Last active {formatRelativeTime(app.lastActivityAt)}</span>
                      </>
                    )}
                  </div>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        This will revoke {app.appName}'s access to your account. The app will no
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Recent integration activity on your account</CardDescription>
      </CardHeader>
      <CardContent>
        {logs.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-8 text-center">
            <Clock className="text-muted-foreground/50 h-12 w-12" />
            <p className="text-muted-foreground mt-4 text-sm">No activity yet</p>
            <p className="text-muted-foreground text-xs">Integration activity will appear here</p>
          </div>
        ) : (
