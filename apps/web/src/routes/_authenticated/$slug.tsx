  ...
  const menuItems = [
    {
      ...
      items: [
        ...
        { icon: FileText, label: 'Documents', href: `/${slug}/documents`, show: permissions?.permissions.canCreateDocuments },
        { icon: LayoutTemplate, label: 'Templates', href: `/${slug}/templates`, show: permissions?.permissions.canCreateTemplates },
        { icon: BarChart3, label: 'Analytics', href: `/${slug}/analytics`, show: true },
      ],
    },
    {
      title: 'Settings',
      items: [
        { icon: Settings, label: 'General', href: `/${slug}/settings`, show: permissions?.permissions.canViewSettings },
        { icon: Users, label: 'Team', href: `/${slug}/settings/team`, show: permissions?.permissions.canViewMembers },
        { icon: Webhook, label: 'Webhooks', href: `/${slug}/settings/webhooks`, show: permissions?.permissions.canManageWebhooks },
        { icon: Key, label: 'API Keys', href: `/${slug}/settings/api`, show: permissions?.permissions.canManageAPIKeys },
      ],
    },
  ];
