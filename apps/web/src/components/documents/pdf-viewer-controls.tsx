...
export function PdfViewerControls({
  ...
  return (
    <TooltipProvider>
      <div
        className={cn(
          "bg-kumo-surface/95 flex items-center gap-1 rounded-lg border p-1.5 shadow-sm backdrop-blur-sm sm:gap-2 sm:p-2",
          className
        )}
      >
        {/* Page Navigation */}
        <div className="flex items-center">
          ...
          >
            ...
            />
            <span className="text-kumo-secondary text-xs whitespace-nowrap sm:text-sm">
              / {totalPages}
            </span>
          </form>
        ...
        <div className="bg-kumo-hairline hidden h-5 w-px sm:block sm:h-6" />
        ...
        <div className="flex items-center">
          ...
          <Select
            ...
            onValueChange={(value) => {
              if (value) handleZoomChange(Number.parseFloat(value));
            }}
            size="sm"
