...
- **25 Tools**: Complete API coverage for documents, recipients, templates, and signatures
- **4 Resources**: Access to documents, templates, recipients, and webhooks
...
- `seal://recipients/{documentId}` - Browse document recipients
- `seal://webhooks` - Browse webhook endpoints
