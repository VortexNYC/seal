...
```
GET /api/v1/documents/:documentId/recipients
```
...
const response = await fetch(
  'https://seal.convex.site/api/v1/documents/jd7k8l9m0n1p2q3r4s5t6u7v/recipients',
  {
    headers: {
...
```bash
curl -X GET https://seal.convex.site/api/v1/documents/jd7k8l9m0n1p2q3r4s5t6u7v/recipients \
...
```
GET /api/v1/documents/:documentId/recipients/:id
```
...
```typescript
const response = await fetch(
  'https://seal.convex.site/api/v1/documents/jd7k8l9m0n1p2q3r4s5t6u7v/recipients/rec_abc123',
  {
    headers: {
      'Authorization': 'Bearer ak_your_api_key_here'
    }
...
```bash
curl -X GET https://seal.convex.site/api/v1/documents/jd7k8l9m0n1p2q3r4s5t6u7v/recipients/rec_abc123 \
  -H "Authorization: Bearer ak_your_api_key_here"
```
...
```
POST /api/v1/documents/:documentId/recipients
```
...
```bash
curl -X POST https://seal.convex.site/api/v1/documents/jd7k8l9m0n1p2q3r4s5t6u7v/recipients \
  -H "Authorization: Bearer ak_your_api_key_here" \
...
```
PATCH /api/v1/documents/:documentId/recipients/:id
```
...
```bash
curl -X PATCH https://seal.convex.site/api/v1/documents/jd7k8l9m0n1p2q3r4s5t6u7v/recipients/rec_abc123 \
  -H "Authorization: Bearer ak_your_api_key_here" \
  -H "Content-Type: application/json" \
  -d '{
    "name": "John Smith",
...
```
DELETE /api/v1/documents/:documentId/recipients/:id
```
...
```bash
curl -X DELETE https://seal.convex.site/api/v1/documents/jd7k8l9m0n1p2q3r4s5t6u7v/recipients/rec_abc123 \
  -H "Authorization: Bearer ak_your_api_key_here"
```
...
```
POST /api/v1/documents/:documentId/recipients/:id/remind
```
...
```typescript
const response = await fetch(
  'https://seal.convex.site/api/v1/documents/jd7k8l9m0n1p2q3r4s5t6u7v/recipients/rec_abc123/remind',
  {
    method: 'POST',
    headers: {
      'Authorization': 'Bearer ak_your_api_key_here',
...
```bash
curl -X POST https://seal.convex.site/api/v1/documents/jd7k8l9m0n1p2q3r4s5t6u7v/recipients/rec_abc123/remind \
  -H "Authorization: Bearer ak_your_api_key_here" \
  -H "Content-Type: application/json" \
  -d '{
...
await fetch('https://seal.convex.site/api/v1/documents/doc123/recipients', {
  method: 'POST',
  headers: {
