...
```typescript
const response = await fetch('https://seal.convex.site/api/v1/templates/tpl_abc123', {
  headers: {
    'Authorization': 'Bearer ak_your_api_key_here'
  }
});
...
```bash
curl -X GET https://seal.convex.site/api/v1/templates/tpl_abc123 \
  -H "Authorization: Bearer ak_your_api_key_here"
```
...
```typescript
const response = await fetch('https://seal.convex.site/api/v1/templates/tpl_abc123/fields', {
  headers: {
    'Authorization': 'Bearer ak_your_api_key_here'
  }
});
...
| `field_values` | object | No | Field values to populate |
| `recipients` | array | No | Recipients to add |

### TypeScript Example

```typescript
const response = await fetch('https://seal.convex.site/api/v1/templates/tpl_abc123/use', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer ak_your_api_key_here',
    'Content-Type': 'application/json'
