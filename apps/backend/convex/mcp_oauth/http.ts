...
export const registerClient = httpAction(async (ctx, request) => {
	...
	try {
		...
		const result = await ctx.runMutation(
			internal.mcp_oauth.mutations.registerClient,
			body,
		);
...
export const getClient = httpAction(async (ctx, request) => {
	...
	try {
		...
		const client = await ctx.runQuery(
			internal.mcp_oauth.queries.getClientById,
			{ clientId },
		);
...
export const getAuthorizationCode = httpAction(async (ctx, request) => {
	...
	try {
		...
		const code = await ctx.runQuery(
			internal.mcp_oauth.queries.getAuthorizationCode,
			{ codeHash },
		);
...
export const deleteAuthorizationCode = httpAction(async (ctx, request) => {
	...
	try {
		...
		const result = await ctx.runMutation(
			internal.mcp_oauth.mutations.deleteAuthorizationCode,
			{ codeHash },
		);
...
export const createRefreshToken = httpAction(async (ctx, request) => {
	...
	try {
		...
		const result = await ctx.runMutation(
			internal.mcp_oauth.mutations.createRefreshToken,
			body,
		);
...
export const getRefreshToken = httpAction(async (ctx, request) => {
	...
	try {
		...
		const token = await ctx.runQuery(
			internal.mcp_oauth.queries.getRefreshToken,
			{ tokenHash },
		);
...
export const deleteRefreshToken = httpAction(async (ctx, request) => {
	...
	try {
		...
		const result = await ctx.runMutation(
			internal.mcp_oauth.mutations.deleteRefreshToken,
			{ tokenHash },
		);
...
export const validateRedirectUri = httpAction(async (ctx, request) => {
	...
	try {
		...
		const result = await ctx.runQuery(
			internal.mcp_oauth.queries.validateRedirectUri,
