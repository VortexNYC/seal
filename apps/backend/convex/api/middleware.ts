 ...
 * - `limit` (optional): number of items per page, clamped to [1, maxLimit]; defaults to `defaults.limit`.
 * - `cursor` (optional): opaque cursor for the next page; returned as-is for cursor-based pagination.
 *
