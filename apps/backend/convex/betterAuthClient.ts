...
import { createBetterAuthUserSyncTriggers } from "@plasmapos/vortex-auth/better-auth/convex";
...
const authFunctions: AuthFunctions = (internal as unknown as { betterAuthClient: AuthFunctions })
  .betterAuthClient;
