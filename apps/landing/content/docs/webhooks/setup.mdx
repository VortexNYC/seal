...
<Callout type="warn">
  **Important**: The webhook secret is only shown once during creation. Store it securely in your
...
<Callout type="info">
  **Auto-Disable**: Webhooks are automatically disabled after 5 consecutive delivery failures.
  Re-enable them after fixing the issue.
</Callout>
