...
const response = await fetch(
  "https://seal.convex.site/api/v1/templates?category=HR",
  {
    headers: {
...
```typescript
const response = await fetch(
  "https://seal.convex.site/api/v1/templates/get?id=tpl_abc123",
  {
    headers: {
      Authorization: "Bearer ak_your_api_key_here",
    },
...
```typescript
const response = await fetch(
  "https://seal.convex.site/api/v1/templates/fields?id=tpl_abc123",
  {
    headers: {
      Authorization: "Bearer ak_your_api_key_here",
    },
...
```typescript
const response = await fetch(
  "https://seal.convex.site/api/v1/templates/update?id=tpl_abc123",
  {
    method: "PUT",
    headers: {
      Authorization: "Bearer ak_your_api_key_here",
...
```typescript
const response = await fetch(
  "https://seal.convex.site/api/v1/templates/delete?id=tpl_abc123",
  {
    method: "DELETE",
    headers: {
      Authorization: "Bearer ak_your_api_key_here",
...
```typescript
const response = await fetch(
  "https://seal.convex.site/api/v1/templates/use?id=tpl_abc123",
  {
    method: "POST",
    headers: {
      Authorization: "Bearer ak_your_api_key_here",
...
- **[Documents API](/developer/api-reference/documents)** - Create documents from templates
- **[Quick Start](/developer/getting-started/quick-start)** - Integration tutorial
