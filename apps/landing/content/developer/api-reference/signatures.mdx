...
<Callout type="info">
  **Legal Validity**: Seal signatures comply with ESIGN Act and eIDAS regulations for electronic
  signatures. The audit trail provides legally admissible evidence of signing events.
</Callout>

## Next Steps

- **[Documents API](/developer/api-reference/documents)** - Manage signed documents
- **[Webhooks](/developer/webhooks)** - Receive real-time signature notifications
