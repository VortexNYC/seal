...
```typescript
const response = await fetch("https://api.seal.nyc/api/v1/webhooks", {
  headers: {
...
const response = await fetch(
  "https://api.seal.nyc/api/v1/webhooks/get?id=wh_abc123",
  {
    headers: {
      Authorization: "Bearer ak_your_api_key_here",
    },
...
```typescript
const response = await fetch(
  "https://api.seal.nyc/api/v1/webhooks/update?id=wh_abc123",
  {
    method: "PUT",
    headers: {
      Authorization: "Bearer ak_your_api_key_here",
...
```typescript
const response = await fetch(
  "https://api.seal.nyc/api/v1/webhooks/delete?id=wh_abc123",
  {
    method: "DELETE",
    headers: {
      Authorization: "Bearer ak_your_api_key_here",
...
```typescript
const response = await fetch(
  "https://api.seal.nyc/api/v1/webhooks/rotate-secret?id=wh_abc123",
  {
    method: "POST",
    headers: {
      Authorization: "Bearer ak_your_api_key_here",
...
See the [Webhooks Guide](/developer/webhooks) for the complete list of 17 event types and their payloads.
...
- **[Webhooks Guide](/developer/webhooks)** - Complete webhook setup and verification guide
- **[Error Handling](/developer/getting-started/error-handling)** - Handle webhook delivery failures
