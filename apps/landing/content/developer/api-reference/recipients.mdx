...
<Callout type="info">
  **Note**: The `signing_url` is only included when retrieving a single recipient. This URL allows
  the recipient to access the document directly without authentication.
</Callout>
...
<Callout type="warn">
  **Warning**: You cannot change a recipient's role or email after they have viewed or signed the
  document. Create a new recipient instead.
</Callout>
