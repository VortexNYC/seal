...
<Callout type="info">
  **Sequential Signing**: Set the `order` field on recipients to enforce a signing sequence.
  Recipient 2 won't receive the document until Recipient 1 completes their action.
</Callout>
