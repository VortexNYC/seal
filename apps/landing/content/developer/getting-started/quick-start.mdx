...
const uploadResponse = await fetch(
  "https://seal.convex.site/api/v1/uploads/generate-url",
  {
    method: "POST",
    headers: {
...
const documentResponse = await fetch(
  "https://seal.convex.site/api/v1/documents",
  {
    method: "POST",
    headers: {
      Authorization: "Bearer ak_your_api_key_here",
...
for (const recipient of recipients) {
  await fetch(
    `https://seal.convex.site/api/v1/recipients?document_id=${document.id}`,
    {
      method: "POST",
      headers: {
        Authorization: "Bearer ak_your_api_key_here",
