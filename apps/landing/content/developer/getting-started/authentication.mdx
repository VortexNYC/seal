...
description: Learn how to authenticate API requests using Clerk API keys with scope-based access control
---
...
<Callout type="warn">
  **Security Best Practice**: Store API keys securely and never commit them to version control.
