...
<Callout type="info">
  **Privacy**: The MCP server only accesses data you explicitly authorize. AI assistants cannot
  access your Seal account without your permission.
</Callout>
...
- **[MCP Tools Reference](/developer/mcp/tools)** - Complete tool documentation
- **[MCP Authentication](/developer/mcp/authentication)** - OAuth setup guide
- **[API Reference](/developer/api-reference)** - Underlying REST API documentation
