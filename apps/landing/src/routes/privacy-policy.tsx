    ...
    <div className="bg-background py-24 sm:py-32">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <article className="prose prose-sm md:prose-base prose-neutral dark:prose-invert max-w-none">
          ...
          <p>
            Seal (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is
            committed to protecting your privacy. This Privacy Policy explains
            how we collect, use, disclose, and safeguard your information when
            you use our document signing platform (&quot;Service&quot;).
          </p>
          ...
          <p>
            When you join the waitlist or sign up through an invitation, we
            collect information provided during authentication, including your
            name, email address, and profile image.
          </p>

          <h3>Document Data</h3>
          <p>
            When you use the Service, we store the documents you upload,
            signature images, form field data, and recipient information (names
            and email addresses) that you provide.
          </p>

          <h3>Signing Activity</h3>
          <p>
            For each document signing event, we collect audit trail data
            including:
          </p>
          <ul>
          ...
          <p>
            Payment processing is handled by Vortex Payments. We do not store
            your full credit card number or banking details in Seal.
          </p>

          <h3>Usage Data</h3>
          <p>
            We automatically collect information about how you interact with the
            Service, including pages visited, features used, browser type,
          ...
          <ul>
            ...
            <li>
              Send transactional emails (document invitations, reminders,
          ...
          <ul>
            ...
            <li>
              <strong>Documents and signatures</strong> — Retained for the
              duration of your account plus a reasonable period to fulfill legal
              and compliance obligations
            </li>
            <li>
              <strong>Audit trails</strong> — Retained for a minimum of 7 years
              to support the legal enforceability of signed documents
            </li>
            <li>
          ...
          <p>
            ...
            days, except where retention is required by law or necessary to
            maintain the integrity of signed documents.
          </p>
          ...
          <p>
            ...
            <a href="mailto:privacy@seal.co">privacy@seal.co</a>. We will
          ...
          <p>
            ...
            These services collect anonymized usage data and do not track you
          ...
          <p>
            Your data may be processed and stored in the United States. By using
            the Service, you consent to the transfer of your data to the United
          ...
          <ul>
            ...
            <li>
              General support:{" "}
              <a href="mailto:support@seal.co">support@seal.co</a>
            </li>
          </ul>
          <p>
