...
Envelope also includes `payloadMode` (`full` or `minimal`) when delivered from
current Seal workers. See [Sensitive egress](/getting-started/egress) for
redaction.
...
- **[Webhook Setup](/docs/webhooks/setup)** - Detailed configuration guide
- **[Signature Verification](/docs/webhooks/verification)** - Security implementation
