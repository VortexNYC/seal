...
def _get_kwargs(
    *,
    body: UpdateTemplateBody | Unset = UNSET,
    id: str,
) -> dict[str, Any]:
...
) -> Error | UpdateTemplateResponse200 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | UpdateTemplateResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Error | UpdateTemplateResponse200
    """
