...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | VerificationResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Verify document integrity
     ...
     Verifies the cryptographic integrity of all signatures on a document. Returns whether the document
