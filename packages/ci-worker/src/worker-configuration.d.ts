/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: f30487a92fd5eb886d4245afa1fa9f76)
// Runtime types generated with workerd@1.20260911.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	BACKUP_BUCKET: R2Bucket;
	ARTIFACTS: Artifacts;
	BACKUP_BUCKET_NAME: "vortex-sign-ci-backups";
