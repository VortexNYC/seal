...
- Setting up auth providers (Convex Auth, WorkOS AuthKit, Auth0, custom JWT)
...
- Dependencies such as `@workos-inc/*`, `@auth0/*`, or Convex Auth packages
