...
const generatedOrInstalledGlobExcludes = [
  // AGENTS.md is generated by @vortexnyc/tooling project-kit (drift-gated); its Core-owned
  // doctrine cites the retired provider as an external comparison standard. Seal cannot
  // reword it, so it is exempt from the residue scan; all other guidance stays scanned.
  "!AGENTS.md",
  "!.git/**",
  "!node_modules/**",
  "!**/node_modules/**",
